        ...
        <div class="form-container">
            ...
            <form method="POST" action="<?= site_url("{$controller}/plati") ?>">
                <div class="form-group">
                    ...
                    <input onclick="enableDisableInput()" type="radio" name="placanje" checked> online placanje
            <br>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input onclick="enableDisableInputDostava()" type="radio" name="dostava" checked> Dostava na adresu
