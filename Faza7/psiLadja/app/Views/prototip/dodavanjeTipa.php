...
<body class="tek">
    ...
    <div class="container tek text-center">
        ...
        <h1 class="pitanje" >DODAVANJE TIPA</h1>
        </div>
        <div class="form-container">
            <h2>Unesite podatke</h2>
            <form method="post" action="<?= site_url("{$controller}/dodavanjeTipaMetod") ?>">
                <div class="form-group">
                    <label for="naziv">Naziv tipa:</label>
                    <input type="text" class="naziv" name="naziv">
                
                </div><div class="form-group">
                    <label for="slikaTipa">Unesite sliku:</label>
                    <input type="text" class="slikaTipa" name="slikaTipa">
                </div>
                <button class="btn btn-secondary">Dodaj tip</button>
            </form>
        </div>
