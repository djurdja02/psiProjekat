        ...
        <br><div class="modeli">
            <table class="tabelaModeli text-center">
                <?php 
                        ...
                        $model = new ModelNamestaja();
                        $results = $model->where('IdTip',$IdTipData)->findAll();
                        ...
                        foreach ($results as $row) {
                            ...
                            echo "<td class='natpisi'><a href='" . site_url("{$controller}/prikaziStranicuProizvodGotov/{$idModela}") . "'>{$naziv}</a></td></tr>";
