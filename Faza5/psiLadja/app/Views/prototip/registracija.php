        ...
        <div class="form-container">
            ...
            <form name="loginform" action="<?= site_url('Gost/register') ?>" method="post">
                <div class="form-group">
                    ...
                    <input type="text" id="Ime" name="Ime" placeholder="Unesite korisničko ime..." required>
                </div>
                <div class="form-group">
                    <label for="Prezime">Prezime:</label>
                    <input type="text" id="Prezime" name="Prezime" placeholder="Unesite korisničko ime..." required>
                </div>
                <div class="form-group">
