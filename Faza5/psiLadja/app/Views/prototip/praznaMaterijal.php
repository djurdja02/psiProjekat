...
<body class="tek">
    ...
    <div class="container tek text-center">
        ...
        <h1 class="pitanje">MATERIJALI</h1>
        <br><div class="modeli">
            <table class="tabelaModeli text-center">
                <?php 
                        use App\Models\SlikaMaterijal;
                        use App\Models\Materijal;
                        $model = new SlikaMaterijal();
                        $modelMaterijal = new Materijal();
                        ...
                        foreach ($results as $row) {
                            ...
                            $red = $modelMaterijal->where('IdMat', $idMat)->find()[0];
                            $nazivMaterijala = $red->Naziv;
                            $cena = $red->Cena;
                            //$naziv = $row->Naziv;
                            ...
                            echo "<td class='natpisi'> {$nazivMaterijala}<br>{$cena}</a></td></tr>";
