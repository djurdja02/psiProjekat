...
<body class="tek">
    ...
    <div class="container tekst text-center">
        <h1 id="pitanje">Radnja koju ste pokusali da odradite nije dozvoljena!</h1>

    <div class="text-center tekst">
        <span id="greska" class="tekst"></span>
        <p>Vratite se na <a href="<?= site_url("{$controller}/prikaziStranicuPocetna") ?>">pocetnu stranicu</a>...</p>
    </div>
