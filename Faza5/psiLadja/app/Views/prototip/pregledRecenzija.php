...
<body class="tek">
    ...
    <div class="container tek text-center">
        ...
        <div class="text-center recenzije">
            <div class="telo">
                <div class="pod">
                <p id="listaP">Sortiraj recenzije prema kategoriji:</p>
                <select name="" id="" size="1" class="lista">
                    <option value="1" selected>Najrelevantnije</option>
                    <option value="2">Prvo najnovije</option>
                    <option value="3">Prvo najstarije</option>
                    <option value="4" >Najvise ocene</option>
                    <option value="5" >Najnize ocene</option>
                </select>
                </div>
            </div>
        </div>
        ...
        <div class="recenzije">
            ...
            foreach ($recenzije as $rec) {
                ...
                echo '<p>' . $rec->Ocena . ', ' . $rec->Komentar . '</p>';
                echo '</div>';
            }
