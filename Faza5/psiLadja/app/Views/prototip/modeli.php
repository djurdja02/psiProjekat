        ...
        <br><div class="modeli">
            <table class="tabelaModeli text-center">
                <tr>
                    ...
                    <td class="celije">
                        <div class="card" style="width: 350px; height:300px; ">
                            <img src="<?php echo base_url('slike/sto3a.jpg') ?>" class="card-img-top" alt="Slika 2">
                            <div class="card-body">
                            </div>
                        </div>
                    </td>
               ...
               <tr>
                <td class="natpisi"><a href="<?= site_url("{$controller}/prikaziStranicuProizvodPMeri") ?>">INDUSTRIJSKI STO</a></td>
                <td class="natpisi"><a href="<?= site_url("{$controller}/prikaziStranicuProizvodPMeri2") ?>">STO ZA RUCAVANJE</a></td>
                <td class="natpisi"><a href="<?= site_url("{$controller}/prikaziStranicuProizvodPMeri3") ?>">NISKI STO</a></td>
               </tr>
            </table>
        </div>
