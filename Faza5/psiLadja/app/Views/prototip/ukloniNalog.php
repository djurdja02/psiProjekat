...
<body class="tek">
    ...
    <div class="text-center">
        <h1 class="pitanje">Unesite korisnicko ime naloga koji uklanjate:</h1>>
        
        <form action="<?php echo base_url('Administrator/ukloniNalog'); ?>" method="POST">
            <input type="text" id="korIme" name="korIme">
            <button class="btn btn-secondary" type="submit">Ukloni nalog</button>
        </form>
        <p id="poruka">
