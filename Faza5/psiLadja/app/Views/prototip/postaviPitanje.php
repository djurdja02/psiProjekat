...
<body class="tek">
    ...
    <div class="container tek text-center">
        <h1 class="pitanje">Sta vas zanima?</h1>

    <div class="flex-containerA">
     

    <form action="<?= site_url("{$controller}/postaviPitanje") ?>" method="post">
        <div class="flex-containerA">
            <div>
                <textarea name="pitanje" rows="5" cols="50" class="textareaA"></textarea>
            </div>

            <div>
                <?php if(isset($poruka)) echo "<font color='red'>$poruka</font><br>"; ?> <br>
                <button type="submit" class="button-arounder">Postavi pitanje</button>
            </div>
        </div>
    </form>  
