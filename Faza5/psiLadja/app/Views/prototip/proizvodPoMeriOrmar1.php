...
<body class="tek">
    ...
    <div class="container tek text-center">
        ...
        <h1 class="pitanje" >JEDNOKRILNI ORMAR</h1><br>
        <br><div class="proizvod">
            <table class="proizvod text-center center">
                <tr>
                    <td class="slikeProizvoda"><img src="<?php echo base_url('slike/orm1kr1.jpg') ?>"></td>
                    <td class="pTekst"><div class="card-body">
                        <h4 class="card-title">Apolon</h4>
                        <p class="card-text">Jednokrilni ormar, uklapa se u svaki enterijer. </p>
                        <a href="<?= site_url("{$controller}/prikaziStranicuPorucivanjeProizvoda") ?>" class="btn btn-secondary">Poruci proizvod</a>
                    </div></td>
                </tr>
                <tr>
                    
                    <td class="slikeProizvoda"><img src="<?php echo base_url('slike/orm1k2.jpg') ?>"></td>
                    <td class="pTekst"><div class="card-body">
                        <h4 class="card-title">Posejdon</h4>
                        <p class="card-text">Jednokrilni ormar, uklapa se u svaki enterijer. </p>
                        <a href="<?= site_url("{$controller}/prikaziStranicuPorucivanjeProizvoda") ?>" class="btn btn-secondary">Poruci proizvod</a>
                    </div></td>
                </tr>
