...
<body class="tek">
    ...
    <div class="container tek text-center">
        ...
        <h1 class="pitanje" >NISKI STO</h1><br>
        <br><div class="proizvod">
            <table class="proizvod text-center center">
                <tr>
                    <td class="slikeProizvoda"><img src="<?php echo base_url('slike/low1.jpg') ?>"></td>
                    <td class="pTekst"><div class="card-body">
                        <h4 class="card-title">Rafaelo</h4>
                        <p class="card-text">Niski sto sa metalnim nogarima, uklapa se u svaki enterijer. </p>
                    </div></td>
                </tr>
                <tr>
                    
                    <td class="slikeProizvoda"><img src="<?php echo base_url('slike/low2.jpg') ?>"></td>
                    <td class="pTekst"><div class="card-body">
                        <h4 class="card-title">Mikelandjelo</h4>
                        <p class="card-text">Niski sto od drveta. </p>
                    </div></td>
                </tr>
            </table>
        </div>
