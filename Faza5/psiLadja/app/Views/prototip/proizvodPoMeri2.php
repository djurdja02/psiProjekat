...
<body class="tek">
    ...
    <div class="container tek text-center">
        ...
        <h1 class="pitanje" >STO ZA RUCAVANJE</h1><br>
        <br><div class="proizvod">
            <table class="proizvod text-center center">
                <tr>
                    <td class="slikeProizvoda"><img src="<?php echo base_url('slike/dinn1.png') ?>"></td>
                    <td class="pTekst"><div class="card-body">
                        <h4 class="card-title">Anabela</h4>
                        <p class="card-text">Sto za rucavanje sa metalnim nogarima, uklapa se u svaki enterijer. </p>
                ...
                <tr>
                    ...
                    <td class="slikeProizvoda"><img src="<?php echo base_url('slike/dinn2.jpg') ?>"></td>
                    <td class="pTekst"><div class="card-body">
                        <h4 class="card-title">Donatela</h4>
                        <p class="card-text">Sto za rucavanje od drveta. </p>
                        <a href="<?= site_url("{$controller}/prikaziStranicuPorucivanjeProizvoda") ?>" class="btn btn-secondary">Poruci proizvod</a>
                    </div></td>
                </tr>
            </table>
